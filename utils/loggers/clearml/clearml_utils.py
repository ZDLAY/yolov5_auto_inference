...
class ClearmlLogger:
    ...
    basic images metrics and analyses.
    ...
    def __init__(self, opt, hyp):
        ...
        if self.clearml:
            ...
            if opt.data.startswith('clearml://'):
                ...
                # Set images to data_dict because wandb will crash without this information and opt is the best way
                # to give it to them
    ...
    def log_image_with_boxes(self, image_path, boxes, class_names, image, conf_threshold=0.25):
        ...
        image (Tensor): A torch tensor containing the actual image images
        """
